...
{
    /// <summary>
    /// DEVNOTE: Taken from - https://github.com/aspnet/Mvc/blob/dev/test/Microsoft.AspNetCore.Mvc.Core.Test/ModelBinding/EnumerableValueProviderTest.cs
    /// to ensure the <see cref="DelimitedQueryStringValueProvider"/> covers all other value provider tests the Microsoft cover.
    /// </summary>
    public abstract class EnumerableValueProviderTest
    {
        private static readonly Dictionary<string, StringValues> BackingStore = new Dictionary<string, StringValues>
                                                                                 {
